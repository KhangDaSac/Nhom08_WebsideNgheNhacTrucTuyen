      ...
      <Navbar.Collapse>
          <form className="mx-auto">
            ...
            <div className="relative">
              ...
              <input type="search" className="w-full block p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search songs, artists,..." required />
            </div>
          </form>
      </Navbar.Collapse>
      <Navbar.Collapse>
